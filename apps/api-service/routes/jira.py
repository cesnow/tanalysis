...
from shared.schemas.jira import ListTicketsResponse, SyncTicketsResponse
from shared.services.jira_service import fetch_jira_tickets, get_tickets_from_mongo
